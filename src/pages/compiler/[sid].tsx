...
const Compiler: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (authLoading || !user || typeof sessionData.sessionId !== 'string' || typeof sessionData.userId !== 'string') return;

        const unsubscribe = onSnapshot(doc(firestore, `sessions/${sessionData.sessionId}/users`, sessionData.userId), (docSnapshot) => {
